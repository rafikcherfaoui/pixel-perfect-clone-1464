      ...
      <header className="h-16 border-b border-border bg-card/50 backdrop-blur-sm flex items-center px-5 gap-4">
        ...
        {role === 'dg' && (
          <div className="flex items-center gap-3 flex-1 justify-end">
            <span className="text-xs font-medium text-muted-foreground">Vue Stratégique</span>
            <DateRangePicker label="30 derniers jours" />
          </div>
        )}

        {role === 'controlling' && (
          <div className="flex items-center gap-3 flex-1 justify-end">
            <span className="text-xs font-medium text-muted-foreground">Période d'analyse</span>
            <DateRangePicker label="Mois en cours" />
          </div>
        )}
      </header>
